...
const Icons = ({ type, paint }) => {
    ...
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox={icons[type].viewBox} className={`inline-block fill-current ${paint}`} fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
